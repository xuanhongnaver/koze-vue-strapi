                            ...
                            <ul class="navbar-nav ms-auto">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item">
                                            <router-link to="/services-details/software-development" class="nav-link">
                                                Services Details
                                            </router-link>
                                        </li>
                                    </ul>
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item">
                                            <router-link to="/single-blog-1/how-technology-dominate-in-the-new-world-in-2022" class="nav-link">
                                                Blog Details
                                            </router-link>
                                        </li>
                                    </ul>
...
export default {
    ...
    created: async function (){
        const response = await axios.get('http://localhost:1337/api/navbar?populate=*')
        const { data: {attributes} } = response.data
        const {image: {data: { attributes: {url} }}} = attributes
        this.navbar = attributes
        this.navbarImg = url
    },
};
</script>
